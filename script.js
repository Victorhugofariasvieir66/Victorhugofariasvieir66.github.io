...
whatsappLink.href = `https://wa.me/${PROFILE.whatsapp}?text=${encodeURIComponent('Hello Victor, I found your portfolio and would like to talk about an opportunity.')}`;
...
// Feedback form: opens user's email client with fields already filled.
